...
window.selectStateEverywhere = function(state) {
    // Profil-Dropdown
    if (window.profileDropdown && window.profileDropdown.value !== state) {
        window.profileDropdown.value = state;
        window.profileDropdown.dispatchEvent(new Event('change'));
    }
    
    // Timeline-Dropdown
    if (window.timelineDropdown && window.timelineDropdown.value !== state) {
        window.timelineDropdown.value = state;
        window.timelineDropdown.dispatchEvent(new Event('change'));
    }
};
